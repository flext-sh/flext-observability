...
FLEXT Observability - Enterprise Monitoring, Metrics & Telemetry
...
2. Confirm parent MRO chain via `pyproject.toml` `dependencies` filtered by `flext-*` (excluding `flext-observability` self).
...
- Public extensions exposed by this project: `FlextObservabilitySettings`, `FlextObservabilityCustomMetrics`, `FlextObservabilityUtilities`, `FlextObservabilityPerformance`, `FlextObservabilityHealth`, `FlextObservabilityServices` (+15 more).
