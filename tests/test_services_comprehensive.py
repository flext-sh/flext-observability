...
class TestFlextMetricsServiceComprehensive:
    ...
    def test_record_metric_invalid_metric_none(self) -> None:
        ...
        result = service.record_metric(None)  # type: ignore
    ...
    def test_get_metric_value_exception(self) -> None:
        ...
        service._metric_gauges["bad_metric"] = "not_a_number"  # type: ignore
    ...
    def test_get_metrics_summary_exception(self) -> None:
        ...
        # Force exception by corrupting internal state
        service._metric_histograms["bad"] = ["not", "numbers"]  # type: ignore
...
class TestFlextTracingServiceComprehensive:
    ...
    def test_start_trace_invalid_trace(self) -> None:
        ...
        result = service.start_trace(None)  # type: ignore
...
class TestFlextLoggingServiceComprehensive:
    ...
    def test_log_entry_success(self) -> None:
        ...
        from flext_observability.flext_simple import flext_create_log_entry
...
class TestFlextAlertServiceComprehensive:
    ...
    def test_create_alert_invalid_alert(self) -> None:
        ...
        result = service.create_alert(None)  # type: ignore
    ...
    def test_create_alert_exception_handling(self) -> None:
        ...
        # Create mock alert that will cause exception
        mock_alert = Mock()
        # Make an attribute access fail
        mock_alert.name = property(lambda self: 1/0)  # type: ignore
...
class TestFlextHealthServiceComprehensive:
    ...
    def test_check_health_invalid_check(self) -> None:
        ...
        result = service.check_health(None)  # type: ignore
...
class TestServicesExceptionHandling:
    ...
    def test_metrics_service_record_exception(self) -> None:
        ...
        # Create metric that will cause exception
        mock_metric = Mock()
        mock_metric.name = "test"
        # Make value property raise exception
        mock_metric.value = property(lambda self: 1/0)  # type: ignore
    ...
    def test_services_time_exception(self, mock_time: Mock) -> None:
        ...
        # Should handle time exception gracefully
        result = service.record_metric(metric_result.data)
        # Result depends on implementation - either succeeds or fails gracefully
