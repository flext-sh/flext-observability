...
- [Simple API functions use flext_create_ prefix](#simple-api-functions-use-flext_create_-prefix)
- [Monitoring functions use flext_monitor_ prefix](#monitoring-functions-use-flext_monitor_-prefix)
...
- [Use patterns directly in business logic](#use-patterns-directly-in-business-logic)
      - [**2. Service Integration Pattern (For FLEXT Services)**](#2-service-integration-pattern-for-flext-services)
- [Import services for advanced integration](#import-services-for-advanced-integration)
