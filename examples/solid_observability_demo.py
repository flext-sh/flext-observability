...
def demonstrate_solid_design() -> None:
    ...
    entities = [metric_result.data, trace_result.data, alert_result.data, health_result.data]
    for entity in entities:
        if hasattr(entity, 'validate_business_rules'):
            validation = entity.validate_business_rules()
            print(f"✅ Liskov Substitution: {type(entity).__name__} validates correctly")
