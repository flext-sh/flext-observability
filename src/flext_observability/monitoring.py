...
class FlextObservabilityMonitor:
    ...
    def flext_get_health_status(self) -> r[t.Observability.HealthMetricsDict]:
        ...
        try:
            ...
            health_data: t.Observability.HealthMetricsDict = {
    ...
    def flext_initialize_observability(self) -> r[None]:
        ...
        try:
            if not self._config:
                return r[None].fail("Configuration not available")
            if (
