...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "ErrorSeverity": ("flext_observability.constants", "ErrorSeverity"),
    ...
    "FlextObservabilityConstants": ("flext_observability._core", "FlextObservabilityConstants"),
